...
export let myChannel: vscode.OutputChannel;
...
export function activateCustomLogging(context: vscode.ExtensionContext) {
    ...
    myChannel = vscode.window.createOutputChannel('PhoLogger: Extension<VSCode Version Selector>');
    // myChannel.clear();
    myChannel.appendLine('Extension<VSCode Version Selector>: Extension activated.');
    myChannel.show(true);
